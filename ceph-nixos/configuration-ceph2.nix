{ modulesPath, config, lib, pkgs, ... }: {
  ...
  services.ceph = {
    ...
    global = {
      ...
      monHost = "[v2:192.168.1.2:3300/0,v1:192.168.1.2:6789/0],[v2:192.168.1.3:3300/0,v1:192.168.1.3:6789/0],[v2:192.168.1.4:3300/0,v1:192.168.1.4:6789/0]";
    };
